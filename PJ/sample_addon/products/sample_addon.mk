...
# Also the prebuilt .jar or .so files to be copied to libs/
...
# define the packages to be included in jar files or jar files will be empty
PRODUCT_SDK_ADDON_STUB_DEFS := package_stub_defs
