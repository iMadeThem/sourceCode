/**
 * AutoCounter.h -- Test the ownership control of the templatized PStash.
 *
 * Copyright (c) Leon (yong.he1982(at)gmail.com)
 * Date : 2013-09-12 [Thursday, 255]
 */

#ifndef _HEADER_AUTOCOUNTER_H_
#define _HEADER_AUTOCOUNTER_H_
...
class AutoCounter {
    ...
    // Prevent assignment and copy-construction: AutoCounter(const AutoCounter&);
