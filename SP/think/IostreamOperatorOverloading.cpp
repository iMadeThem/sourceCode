/**
 * IostreamOperatorOverloading.cpp -- Demo of non-member operators by overloading iostream operator.
 *
 * Copyright (c) Leon (yong.he1982(at)gmail.com)
 * Date : 2013-08-19 [Monday, 231]
 *
 * Build:
 *   g++ IostreamOperatorOverloading.cpp -o IostreamOperatorOverloading
 */

#include "require.h"
#include <iostream>
#include <sstream> // "String streams" #include <cstring>
