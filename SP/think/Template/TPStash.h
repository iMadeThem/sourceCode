/**
 * TPStash.h -- Templatized pointer stash.
 *
 * Copyright (c) Leon (yong.he1982(at)gmail.com)
 * Date : 2013-09-12 [Thursday, 255]
 */

#ifndef _HEADER_TPSTASH_H_
#define _HEADER_TPSTASH_H_
...
class PStash {
    ...
    public:
        PStash() : quantity(0), next(0), storage(0) {} ~PStash();
        int add(T* element);
